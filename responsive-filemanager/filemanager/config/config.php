...
setlocale(LC_CTYPE, 'id_ID'); //correct transliteration
...
$http   = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'];
$newurl = substr(str_replace("index.php","", $_SERVER['SCRIPT_NAME']), 0, -1);
...
$config = array(
    ...
    |
    */
    'base_url' => 'https://tnd.kotabogor.go.id',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |
    */
    'current_path' => '../../assets/imageupload/',
    ...
    |
    */
    'thumbs_base_path' => '../../assets/imageupload/_thumbs/',
    ...
    */
    ...
    'access_keys' => array('a0809c76ed47d7bb56c0988e7becf90876508cdc'),
