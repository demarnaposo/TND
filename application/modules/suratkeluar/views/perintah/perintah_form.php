                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <label class="col-md-2 control-label">Kpd.Internal Pemkot</label>
                                    <div class="col-md-4">                           
                                        <select name="jabatan_id[]" id="jabatan" class="form-control select" data-live-search="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select name="kop_id" class="form-control select" data-live-search="true">
                                            ...
                                            <?php } ?>-->
                                            <option value="1" <?php if($this->session->flashdata('value_kop_id') == 1) echo "selected"?>>Walikota</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
										<textarea id="textarea1" name="untuk"><?php echo $this->session->flashdata('value_untuk') ?></textarea>
                                                ...
                                                <?php foreach (listOpd($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        ...
                                                        <a href="<?php echo site_url('suratkeluar/perintah/delete_kepada/'.$this->uri->segment(4).'/'.$o->dsuratkeluar_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
                        ...
                        <br><div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <?php if (empty($e->pegawai_id)){?>
                                            <span class="help-block"><font color="red">*Daftar Pegawai masih kosong</font> silakan pilih pegawai yang akan diperintahkan</span>
                                        <?php } ?>
                                    </div>
                                    <div class="col-md-1">
                                        <h3><input id="chekall2" type="checkbox" style="width:17px; height:17px;"> Pilih Semua</h3>
                            ...
                            <?php }?>				
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Untuk</label>
                                    <div class="col-md-10">
										<textarea id="textarea1" name="untuk"><?php echo $e->untuk ?></textarea>
                                    </div>
                                </div>	
                                <div class="form-group">                                        
                                    <label class="col-md-2 control-label">Catatan</label>
                                            ...
                                            <div class="faq-text">
                                                ...
                                                <?php foreach (listTembusan($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        - <?= $q->nama_jabatan;?>
                                                        <a href="<?php echo site_url('suratkeluar/perintah/delete_tembusan/'.$this->uri->segment(4).'/'.$o->tembusansurat_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">                                        
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <?php }?>
                                        <span class="help-block">Format hanya berlaku pdf</span><br>
                                    </div>
                                </div>  
