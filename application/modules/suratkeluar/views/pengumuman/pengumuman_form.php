...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo site_url('suratkeluar/pengumuman') ?>">Surat Pengumuman</a></li>
...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Formulir Surat Pengumuman</h2>
</div>
<!-- END PAGE TITLE -->                
            ...
            <?php if ($this->uri->segment(3) == 'add') { ?>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <a href="<?= site_url()?>assets/reviewsurat/PENGUMUMAN.pdf" target="_blank" class="btn btn-default" style="margin-left: 1%">Template Surat</a>
                    </div>
                    <div class="panel-body">                                                                        
                        ...
                        <div class="row">
				            ...
				            <div class="form-group">
                                ...
                                <!-- Update @Mpik Egov 28/07/2022 -->  
				                <div class="form-group">
                                    <label class="col-md-2 control-label">Isi Pengumuman</label>
                                    <div class="col-md-10">
                                                ...
                                                <?php foreach (listOpd($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        ...
                                                        <a href="<?php echo site_url('suratkeluar/pengumuman/delete_kepada/'.$this->uri->segment(4).'/'.$o->dsuratkeluar_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="faq-text">
                                                ...
                                                <?php foreach (listTembusan($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        - <?= $q->nama_jabatan;?>
                                                        <a href="<?php echo site_url('suratkeluar/pengumuman/delete_tembusan/'.$this->uri->segment(4).'/'.$o->tembusansurat_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
