...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Pengumuman </h2>
</div>
<!-- END PAGE TITLE -->                
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <a href="<?php echo site_url('suratkeluar/pengumuman/add') ?>" class="btn btn-primary"><i class="fa fa-plus"></i>Buat Surat</a> <br><br>
                    ...
                    <table class="table datatable table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <?php
                                    $kode=$this->db->query("SELECT kode_surat.kode, kode_surat.tentang FROM surat_pengumuman LEFT JOIN kode_surat ON kode_surat.kodesurat_id=surat_pengumuman.kodesurat_id WHERE surat_pengumuman.kodesurat_id='$h->kodesurat_id'")->row_array();
                                ...
                                <td>
                                    <?php
                                    $kop_id=$this->db->query("SELECT kop_surat.nama FROM surat_edaran LEFT JOIN kop_surat ON kop_surat.kop_id=surat_edaran.kop_id WHERE surat_edaran.kop_id='$h->kop_id'")->row_array();
                                    echo $kop_id['nama'];
                                    ?>
                                </td>
                                <td>
                                ...
                                <td style="font-weight: bold;">
                                    ...
                                    <?php 
                                        ...
                                        $qverifikasi = $this->db->query("
                                            ...
                                            JOIN surat_pengumuman ON verifikasi.surat_id = surat_pengumuman.id
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <?php 
                                                $berada = $this->db->query("
                                                    ...
                                                    JOIN surat_pengumuman ON surat_pengumuman.id = draft.surat_id 
                                                    ...
                                                    WHERE surat_pengumuman.id = '$h->id'
                                                ")->row_array();
                                ...
                                <td align="center">
                                    <?php 
                                        ...
                                        <?php }else{?>
                                            <a href="<?php echo site_url('export/pengumuman/'.$h->id) ?>" title="Lihat Surat" target="_blank"><span class="fa-stack"><i class="fa fa-eye fa-stack-2x"></i></span></a>                                    
                                        <?php }
                                        // END
                                        // Update @Mpik Egov 22/06/2022
                                        }else{
                                        ...
                                        <div class="modal fade" id="modalLihat<?php echo $h->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <a href="<?php echo site_url('export/pengumuman/'.$h->id) ?>" title="Lihat Surat" target="_blank" style="text-decoration: none;" class="btn btn-danger">Lihat Surat</a> 
                                                <a href="<?php echo base_url('assets/lampiransurat/pengumuman/'.$h->lampiran_lain) ?>" title="Lihat Lampiran" target="_blank" style="text-decoration: none;" class="btn btn-warning">Lihat Lampiran</a>
                                              </div>
                                              <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                              </div>
...
<!--============ START [UPDATE] Fikri Egov ================ [UPDATE] Fikri Egov ============================ [UPDATE] Fikri Egov ========================= [UPDATE] Fikri Egov ================================================-->
                                    ...
                                    ?>
                                    | <a href="<?php echo site_url('suratkeluar/pengumuman/edit/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Ubah Surat"><span class="fa-stack"><i class="fa fa-pencil fa-stack-2x"></i></span></a> 
                                    
                                    <?php if ($h->dibuat_id == $this->session->userdata('jabatan_id')) {  ?>
                                    | <a href="<?php echo site_url('suratkeluar/pengumuman/delete/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Hapus Surat" onclick="return confirm('Apakah anda yakin akan menghapus?')"><span class="fa-stack"><i class="fa fa-trash-o fa-stack-2x"></i></span></a>
