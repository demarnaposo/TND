...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Surat Undangan </h2>
</div>
<!-- END PAGE TITLE -->                
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <a href="<?php echo site_url('suratkeluar/undangan/add') ?>" class="btn btn-primary"><i class="fa fa-plus"></i>Buat Surat</a> <br><br>
		    ...
		    <table class="table datatable table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <?php
                                    $kode=$this->db->query("SELECT kode_surat.kode, kode_surat.tentang FROM surat_undangan LEFT JOIN kode_surat ON kode_surat.kodesurat_id=surat_undangan.kodesurat_id WHERE surat_undangan.kodesurat_id='$h->kodesurat_id'")->row_array();
                                ...
                                <td>
                                    <?php
                                    $kop_id=$this->db->query("SELECT kop_surat.nama FROM surat_undangan LEFT JOIN kop_surat ON kop_surat.kop_id=surat_undangan.kop_id WHERE surat_undangan.kop_id='$h->kop_id'")->row_array();
                                    echo $kop_id['nama'];
                                    ?>
                                </td>
                                <td>
				            ...
				            <?php
                                ...
                                <td style="font-weight: bold;">
                                    ...
                                    <?php 
                                        ...
                                        $qverifikasi = $this->db->query("
                                            ...
                                            JOIN surat_undangan ON verifikasi.surat_id = surat_undangan.id
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <?php 
                                                ...
                                                $berada = $this->db->query("
                                                    ...
                                                    JOIN surat_undangan ON surat_undangan.id = draft.surat_id 
                                                    ...
                                                    WHERE surat_undangan.id = '$h->id' AND aparatur.statusaparatur='Aktif'
                                                ")->row_array();
                                                // Update @Mpik Egov 3 August 2022
                                ...
                                <td align="center">
                                    ...
                                    <?php 
                                        ...
                                        <?php }else{?>
                                            <a href="<?php echo site_url('export/undangan/'.$h->id) ?>" title="Lihat Surat" target="_blank"><span class="fa-stack"><i class="fa fa-eye fa-stack-2x"></i></span></a>                                    
                                        <?php }
                                        // END
                                    ...
                                    ?>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <a href="<?php echo base_url('assets/lampiransurat/undangan/'.$h->lampiran_lain) ?>" title="Lihat Lampiran" target="_blank" style="text-decoration: none;" class="btn btn-warning">Lihat Lampiran</a>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                            </div>
                                        ...
                                        <div class="modal fade" id="modalLihat<?php echo $h->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <a href="<?php echo site_url('export/undangan/'.$h->id) ?>" title="Lihat Surat" target="_blank" style="text-decoration: none;" class="btn btn-danger">Lihat Surat</a> 
                                                <a href="<?php echo base_url('assets/lampiransurat/undangan/'.$h->lampiran_lain) ?>" title="Lihat Lampiran" target="_blank" style="text-decoration: none;" class="btn btn-warning">Lihat Lampiran</a>
                                              </div>
                                              <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
...
<!--============ START [UPDATE] Fikri Egov ================ [UPDATE] Fikri Egov ============================ [UPDATE] Fikri Egov ========================= [UPDATE] Fikri Egov ================================================-->
                                    ...
                                    ?>
                                    | <a href="<?php echo site_url('suratkeluar/undangan/duplicate/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Duplicate Surat"><span class="fa-stack"><i class="fa fa-copy fa-stack-2x"></i></span></a> 
                                    | <a href="<?php echo site_url('suratkeluar/undangan/edit/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Ubah Surat"><span class="fa-stack"><i class="fa fa-pencil fa-stack-2x"></i></span></a> 
                                    
                                    <?php if ($h->dibuat_id == $this->session->userdata('jabatan_id')) {  ?>
                                    | <a href="<?php echo site_url('suratkeluar/undangan/delete/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Hapus Surat" onclick="return confirm('Apakah anda yakin akan menghapus?')"><span class="fa-stack"><i class="fa fa-trash-o fa-stack-2x"></i></span></a>
