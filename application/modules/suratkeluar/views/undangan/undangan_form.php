...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo site_url('suratkeluar/undangan') ?>">Surat Undangan</a></li>
...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Formulir Surat Undangan</h2>
</div>
<!-- END PAGE TITLE -->                
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php if ($this->uri->segment(3) == 'add') { ?>
                ...
                <!-- START DEFAULT FORM -->
                <form class="form-horizontal" action="<?php echo site_url('suratkeluar/undangan/insert') ?>" method="post" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <a href="javascript:history.back()" class="btn btn-default">&laquo; Kembali</a>
                        <a href="<?= site_url()?>assets/reviewsurat/SURAT UNDANGAN.pdf" target="_blank" class="btn btn-default" style="margin-left: 1%">Template Surat</a>
                    </div>
                    <div class="panel-body">                                                                        
                        ...
                        <div class="row">
                                            ...
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <input type="hidden" name="surat_id" value="<?php echo $this->uri->segment(4) ?>"> 
                                                    ...
                                                    <input type="text" class="form-control" name="tempat_eksternal">
                                              </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <!-- Update @Mpik Egov 28/07/2022 -->
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Paragrap Pembuka</label>
                                    <div class="col-md-10">
										<textarea id="textarea1" name="p1" rows="6"><?php echo $this->session->flashdata('value_p1') ?></textarea>
                                        <span class="help-block"><font color="red"><?php echo $this->session->flashdata('p1') ?></font></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Hari</label>
                                    <div class="col-md-10">
                                        <input type="text" name="hari" class="form-control" value="<?php echo $this->session->flashdata('value_hari') ?>"/>
                                        <span class="help-block"><font color="red"><?php echo $this->session->flashdata('hari') ?></font></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                            <input type="text" name="tgl_acara" class="form-control" value="<?php echo $this->session->flashdata('value_tgl_acara') ?>"/>
                                            <span class="help-block"><font color="red"><?php echo $this->session->flashdata('tgl_acara') ?></font></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="pukul" class="form-control" value="<?php echo $this->session->flashdata('value_pukul') ?>"/>
                                        <span class="help-block"><font color="red"><?php echo $this->session->flashdata('pukul') ?></font></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Tempat</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="tempat" value="<?php echo $this->session->flashdata('value_tempat') ?>"/>
                                        <span class="help-block"><font color="red"><?php echo $this->session->flashdata('tempat') ?></font></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Acara</label>
                                    <div class="col-md-10">
										<textarea id="summernote6" name="acara" rows="2"><?php echo $this->session->flashdata('value_acara') ?></textarea>
                                        <span class="help-block"><font color="red"><?php echo $this->session->flashdata('acara') ?></font></span>
                                    </div>
                                </div>																
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Paragrap Penutup</label>
                                    <div class="col-md-10">
										<textarea id="textarea2" name="p2" rows="6"><?php echo $this->session->flashdata('value_p2') ?></textarea>
                                        <span class="help-block"><font color="red"><?php echo $this->session->flashdata('p2') ?></font></span>
                                    </div>
                                </div>
                                <div class="form-group">                                        
            ...
            <?php 
                ...
                foreach ($undangan as $key => $e) {
            ?>

                <!-- START DEFAULT FORM -->
                <form class="form-horizontal" action="<?php echo site_url('suratkeluar/undangan/update') ?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo $e->id ?>" />
                <input type="hidden" name="verifikasi_id" value="<?php echo $e->verifikasi_id ?>" />
                                        ...
                                        <div class="faq-item">
                                            ...
                                            <div class="faq-text" style="overflow:auto;">
                                                ...
                                                <?php foreach (listOpd($this->uri->segment(4)) as $key => $o) { ?>
                                                    <p>
                                                        - <?php echo $o->nama_pd ?> 
                                                        <a href="<?php echo site_url('suratkeluar/undangan/delete_kepada/'.$this->uri->segment(4).'/'.$o->dsuratkeluar_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } ?>
                                            </div>
                                        </div>
...
<option value="Penting" <?php if($e->sifat == 'Penting'){ echo "selected"; } ?>>Penting</option>
                               ...
                               <div class="form-group">
                                    <label class="col-md-2 control-label">Paragrap Pembuka</label>
                                    <div class="col-md-10">
					                   <textarea id="textarea1" name="p1" rows="6"><?php echo $e->p1 ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Hari</label>
                                    <div class="col-md-10">
                                            <input type="text" name="hari" class="form-control" value="<?php echo $e->hari; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Tanggal Acara </label>
                                    <div class="col-md-10">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                            <input type="text" name="tgl_acara" class="form-control" value="<?php echo $e->tgl_acara;?>"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Pukul</label>
                                    <div class="col-md-10">
                                            <input type="text" name="pukul" class="form-control" value="<?php echo $e->pukul; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Tempat</label>
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Acara</label>
                                    <div class="col-md-10">
					                   <textarea id="summernote2" name="acara" rows="6"><?php echo $e->acara ?></textarea>
                                    </div>
                                </div>																
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Paragrap Penutup</label>
                                    <div class="col-md-10">
					                   <textarea id="textarea2" name="p2" rows="6"><?php echo $e->p2 ?></textarea><br>
                                    </div>
                                </div>
                                <div class="form-group">                                        
                                    <label class="col-md-2 control-label">Catatan</label>
                                            ...
                                            <div class="faq-text">
                                                ...
                                                <?php foreach (listTembusan($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        - <?= $q->nama_jabatan;?>
                                                        <a href="<?php echo site_url('suratkeluar/undangan/delete_tembusan/'.$this->uri->segment(4).'/'.$o->tembusansurat_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
                ...
                <?php }
                }elseif ($this->uri->segment(3) == 'duplicate') { 
                foreach ($undangan as $key => $e) {
            ?>
                 <!-- START DEFAULT FORM -->
                <form class="form-horizontal" action="<?php echo site_url('suratkeluar/undangan/saveduplicate') ?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo $e->id ?>" />
                <input type="hidden" name="verifikasi_id" value="<?php echo $e->verifikasi_id ?>" />
                <input type="hidden" name="penandatangan_id" value="<?php echo $e->penandatangan_id ?>" />
                <div class="panel panel-default">
                            ...
                            <div class="col-md-12">
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Acara</label>
                                    <div class="col-md-10">
					                   <textarea id="summernote2" name="acara" rows="6"><?php echo $e->acara ?></textarea><br>
                                    </div>
                                </div>
                                <!--<div class="form-group">-->
                                <!--    <label class="col-md-2 control-label">Acara</label>-->
                                <!--    <div class="col-md-10">-->
                                <!--        <input type="text" class="form-control" name="acara" value="<?php echo $e->acara ?>"/>-->
                                <!--    </div>-->
                                <!--</div>																-->
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Paragrap Penutup</label>
                    ...
                    <div class="panel-footer">
                        <button class="btn btn-danger" type="reset">Bersihkan Formulir</button>   
                        <button class="btn btn-primary pull-right" type="submit">Duplicate Surat</button>
                    </div>
                </div>
                </form>
                <!-- END DEFAULT FORM -->
