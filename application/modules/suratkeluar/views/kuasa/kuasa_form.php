...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo site_url('suratkeluar/kuasa') ?>">Surat Kuasa</a></li>
...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Formulir Surat Kuasa</h2>
</div>
<!-- END PAGE TITLE -->                
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php if ($this->uri->segment(3) == 'add') { ?>
                ...
                <!-- START DEFAULT FORM -->
                <form class="form-horizontal" action="<?php echo site_url('suratkeluar/kuasa/insert') ?>" method="post" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <a href="javascript:history.back()" class="btn btn-default">&laquo; Kembali</a>
                        <a href="<?= site_url()?>assets/reviewsurat/SURAT KUASA.pdf" target="_blank" class="btn btn-default" style="margin-left: 1%">Template Surat</a>
                    </div>
                    <div class="panel-body">                                                                        
				            ...
				            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
										<textarea id="textarea1" name="untuk" rows="6"><?php echo $this->session->flashdata('value_untuk') ?></textarea>
            ...
            <?php 
                ...
                foreach ($kuasa as $key => $e) {
            ?>

                <!-- START DEFAULT FORM -->
                <form class="form-horizontal" action="<?php echo site_url('suratkeluar/kuasa/update') ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <?php foreach (listOpd($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        ...
                                                        <a href="<?php echo site_url('suratkeluar/kuasa/delete_kepada/'.$this->uri->segment(4).'/'.$o->dsuratkeluar_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
                        ...
                        <br><div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <select id="pegawai_id "name="pegawai_id" class="form-control select 2" data-live-search="true">
                                            <option value="">Pilih Pegawai</option>
                                            <?php foreach ($pegawai as $key => $a) { ?> 
                                                <option value="<?php echo $a->aparatur_id ?>" <?php if ($a->aparatur_id == $e->pegawai_id) { echo "selected"; } ?>><?php echo $a->nama; ?></option>
											 <?php } ?>
                                        </select>
                                    </div>
							  </div>						
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Untuk</label>
                                    <div class="col-md-10">
										<textarea id="textarea1" name="untuk" rows="6"><?php echo $e->untuk ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">                                        
                                    <label class="col-md-2 control-label">Catatan</label>
                                            ...
                                            <div class="faq-text">
                                                ...
                                                <?php foreach (listTembusan($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        - <?= $q->nama_jabatan;?>
                                                        <a href="<?php echo site_url('suratkeluar/kuasa/delete_tembusan/'.$this->uri->segment(4).'/'.$o->tembusansurat_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
