...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Formulir Surat Panggilan</h2>
</div>
<!-- END PAGE TITLE -->                
            ...
            <?php if ($this->uri->segment(3) == 'add') { ?>
                ...
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        ...
                        <a href="<?= site_url()?>assets/reviewsurat/SURAT PANGGILAN.pdf" target="_blank" class="btn btn-default" style="margin-left: 1%">Template Surat</a>
                    </div>
                    <div class="panel-body">                                                                        
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Di Kantor</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="kantor" value="<?php echo $this->session->flashdata('value_kantor') ?>"/>
                                        <span class="help-block"><font color="red"><?php echo $this->session->flashdata('kantor') ?></font></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                            <input type="text" name="tgl_acara" class="form-control datepicker" value="<?php echo date('Y-m-d') ?>"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input type="time" class="form-control" name="pukul" value="<?php echo $this->session->flashdata('value_pukul') ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select name="menghadapkepada_id" class="form-control select" data-live-search="true" >
                                            <option value="">-- Pilih --</option>
                                            <?php foreach ($jabatan as $key => $h) { ?> 
                                                <option value="<?php echo $h->jabatan_id ?>" <?php if($h->jabatan_id == $this->session->flashdata('value_menghadapkepada_id')) echo "selected"?>><?php echo $h->nama_jabatan; ?></option>
                                            <?php } ?>
                                        </select>
                                        <span class="help-block"><font color="red"><?php echo $this->session->flashdata('menghadapkepada_id') ?></font></span>
                                    </div>
                                </div>								
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Alamat</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="alamat" value="<?php echo $this->session->flashdata('value_alamat') ?>"/>
                                        <span class="help-block"><font color="red"><?php echo $this->session->flashdata('alamat') ?></font></span>
                                    </div>
                                </div>								
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Untuk</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="untuk" value="<?php echo $this->session->flashdata('value_untuk') ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="file" name="lampiran_lain" class="fileinput btn-primary" name="filename" id="filename" title="Cari file" accept="application/pdf" />
                ...
                <div class="panel panel-default">
                                        ...
                                        <div class="faq-item">
                                            ...
                                            <div class="faq-text">
                                                ...
                                                <?php foreach (listOpd($this->uri->segment(4)) as $key => $o) { ?>
                                                    <p>
                                                        - <?php echo $o->nama_pd ?> 
                                                        <a href="<?php echo site_url('suratkeluar/panggilan/delete_kepada/'.$this->uri->segment(4).'/'.$o->dsuratkeluar_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } ?>
                                            </div>
                                        </div>
					...
					<option value="Penting">Penting</option>
                            ...
                            <div class="form-group">                                        
                                <label class="col-md-2 control-label">Lampiran</label>
                                <div class="col-md-10">
                                    <input type="text" name="lampiran" class="form-control" value="<?= $e->lampiran;?>" />
                                </div>
                            </div>
                            <div class="form-group">                                        
                                <label class="col-md-2 control-label">Hal</label>
                                <div class="col-md-10">
                                    <input type="text" name="hal" class="form-control" value="<?= $e->hal;?>" />
                                </div>
                            </div>                            
                            <div class="form-group">
                                <label class="col-md-2 control-label">Di Kantor</label>
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="kantor" value="<?= $e->kantor;?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Tanggal Acara</label>
                                <div class="col-md-10">
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                        <input type="text" name="tgl_acara" class="form-control datepicker" value="<?= $e->tgl_acara;?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Pukul</label>
                                <div class="col-md-2">
                                    <input type="time" class="form-control" name="pukul" value="<?= $e->pukul;?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Tempat</label>
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="tempat" value="<?= $e->tempat;?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Menghadap Kepada</label>
                                <div class="col-md-10">
                                    <select name="menghadapkepada_id" class="form-control select" data-live-search="true" >
                                        <option value="">-- Pilih --</option>
                                        <?php foreach ($jabatan as $key => $h) { ?> 
                                            <option value="<?php echo $h->jabatan_id ?>" <?php if ($h->jabatan_id == $e->menghadapkepada_id) { echo "selected"; } ?>><?php echo $h->nama_jabatan; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>								
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">Untuk</label>
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="untuk" value="<?= $e->untuk;?>"  />
                                </div>
                            </div>
                            <div class="form-group">                                        
                                    <label class="col-md-2 control-label">Catatan</label>
                                            ...
                                            <div class="faq-text">
                                                ...
                                                <?php foreach (listTembusan($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        - <?= $q->nama_jabatan;?>
                                                        <a href="<?php echo site_url('suratkeluar/panggilan/delete_tembusan/'.$this->uri->segment(4).'/'.$o->tembusansurat_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
