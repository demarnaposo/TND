...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Formulir Surat Izin</h2>
</div>
<!-- END PAGE TITLE -->                
            ...
            <?php if ($this->uri->segment(3) == 'add') { ?>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <a href="<?= site_url()?>assets/reviewsurat/SURAT IZIN.pdf" target="_blank" class="btn btn-default" style="margin-left: 1%">Template Surat</a>
                    </div>
                    <div class="panel-body">                                                                        
                        ...
                        <div class="row">
				            ...
				            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="tentang" value="<?php echo $this->session->flashdata('value_tentang') ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
										<textarea id="textarea1" name="dasar" rows="3"><?php echo $this->session->flashdata('value_dasar') ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
										<textarea id="textarea2" name="untuk" rows="6"><?php echo $this->session->flashdata('value_untuk') ?></textarea>
                                        <span class="help-block"><font color="red"><?php echo $this->session->flashdata('untuk') ?></font></span><br>
                                    </div>
                                </div>
                                                ...
                                                <?php foreach (listOpd($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        ...
                                                        <a href="<?php echo site_url('suratkeluar/izin/delete_kepada/'.$this->uri->segment(4).'/'.$o->dsuratkeluar_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
                        ...
                        <br><div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Dasar</label>
                                    <div class="col-md-10">
										<textarea id="textarea1" name="dasar" rows="3"><?php echo $e->dasar ?></textarea>
                                    </div>
                                </div>	
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Daftar Pegawai</label>
                                    <div class="col-md-10">
                                        <select id="pegawai_id "name="pegawai_id" class="form-control select 2" data-live-search="true">
                                            <option value="">Pilih Pegawai</option>
                                            <?php foreach ($pegawai as $key => $a) { ?> 
                                                <option value="<?php echo $a->aparatur_id ?>" <?php if ($a->aparatur_id == $e->pegawai_id) { echo "selected"; } ?>><?php echo $a->nip; ?> - <?php echo $a->nama; ?></option>
											 <?php } ?>
                                        </select>
                                    </div>
							  </div>								
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Untuk</label>
                                    <div class="col-md-10">
										<textarea id="textarea2" name="untuk" rows="6"><?php echo $e->untuk ?></textarea>
                                    </div>
                                </div>
                                            ...
                                            <div class="faq-text">
                                                ...
                                                <?php foreach (listTembusan($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        - <?= $q->nama_jabatan;?>
                                                        <a href="<?php echo site_url('suratkeluar/izin/delete_tembusan/'.$this->uri->segment(4).'/'.$o->tembusansurat_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
