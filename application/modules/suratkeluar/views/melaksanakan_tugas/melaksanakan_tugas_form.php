...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Formulir Surat Pernyataan Melaksanakan Tugas</h2>
</div>
<!-- END PAGE TITLE -->                
            ...
            <?php if ($this->uri->segment(3) == 'add') { ?>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <a href="<?= site_url()?>assets/reviewsurat/SURAT KET MELAKSANAKAN TUGAS.pdf" target="_blank" class="btn btn-default" style="margin-left: 1%">Template Surat</a>
                    </div>
                    <div class="panel-body">                                                                        
                        ...
                        <div class="row">
				            ...
				            <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select name="pegawai_id" class="form-control select" data-live-search="true">
                                            ...
                                            <?php foreach ($pegawai as $key => $a) { ?> 
                                                <option value="<?php echo $a->aparatur_id ?>" <?php if($a->aparatur_id == $this->session->flashdata('value_pegawai_id')) echo "selected"?>><?php echo $a->nip; ?> - <?php echo $a->nama; ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="dasarsk" value="<?php echo $this->session->flashdata('value_dasarsk') ?>"/>
                                        <span class="help-block"><font color="red"><?php echo $this->session->flashdata('dasarsk') ?></font></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Nomor SK</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="nomorsk" value="<?php echo $this->session->flashdata('value_nomorsk') ?>"/>
                                        <span class="help-block"><font color="red"><?php echo $this->session->flashdata('nomorsk') ?></font></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">TMT</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="tmt" value="<?php echo $this->session->flashdata('value_tmt') ?>"/>
                                        <span class="help-block"><font color="red"><?php echo $this->session->flashdata('tmt') ?></font></span>
                                    </div>
                                </div>                             
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Tugas</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="tugas" value="<?php echo $this->session->flashdata('value_tugas') ?>"/>
                                        <span class="help-block"><font color="red"><?php echo $this->session->flashdata('tugas') ?></font></span>
                                    </div>
                                </div>
                                <div class="form-group">                                        
                                                ...
                                                <?php foreach (listOpd($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        ...
                                                        <a href="<?php echo site_url('suratkeluar/melaksanakan_tugas/delete_kepada/'.$this->uri->segment(4).'/'.$o->dsuratkeluar_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="faq-text">
                                                ...
                                                <?php foreach (listTembusan($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        - <?= $q->nama_jabatan;?>
                                                        <a href="<?php echo site_url('suratkeluar/melaksanakan_tugas/delete_tembusan/'.$this->uri->segment(4).'/'.$o->tembusansurat_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
