...
<ul class="breadcrumb">
    ...
    <li class="active">Surat Melaksanakan Tugas</li>
</ul>
<!-- END BREADCRUMB -->

<!-- PAGE TITLE --> 
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Surat Pernyataan Melaksanakan Tugas </h2>
</div>
<!-- END PAGE TITLE -->                
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <a href="<?php echo site_url('suratkeluar/melaksanakan_tugas/add') ?>" class="btn btn-primary"><i class="fa fa-plus"></i>Buat Surat</a> <br><br>
		    ...
		    <table class="table datatable table-bordered">
                        ...
                        <tbody>
                            <?php
                                $no = 1; 
                                foreach ($melaksanakan_tugas as $key => $h) {
                            ?>
                            <tr>
                                <td><?php echo $no; ?></td>
                                ...
                                <td>
                                <?php
                                    $kode=$this->db->query("SELECT kode_surat.kode, kode_surat.tentang FROM surat_melaksanakantugas LEFT JOIN kode_surat ON kode_surat.kodesurat_id=surat_melaksanakantugas.kodesurat_id WHERE surat_melaksanakantugas.kodesurat_id='$h->kodesurat_id'")->row_array();
                                ...
                                <td>
                                    <?php
                                    $kop_id=$this->db->query("SELECT kop_surat.kop_id, kop_surat.nama FROM surat_melaksanakantugas LEFT JOIN kop_surat ON kop_surat.kop_id=surat_melaksanakantugas.kop_id WHERE surat_melaksanakantugas.kop_id='$h->kop_id'")->row_array();
                                    echo $kop_id['nama'];
                                    ?>
                                </td>
                                <td>
                                ...
                                <?php 
                                        ...
                                        $qverifikasi = $this->db->query("
                                            ...
                                            JOIN surat_melaksanakantugas ON verifikasi.surat_id = surat_melaksanakantugas.id
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <?php 
                                                ...
                                                $berada = $this->db->query("
                                                    ...
                                                    JOIN surat_melaksanakantugas ON surat_melaksanakantugas.id = draft.surat_id 
                                                    ...
                                                    WHERE surat_melaksanakantugas.id = '$h->id' AND aparatur.statusaparatur='Aktif'
                                                ")->row_array();
					...
					<!-- Kondisi jika surat belum ditandatangan tidak bisa preview surat -->
                                        ...
                                        <?php }else{?>
                                            <a href="<?php echo site_url('export/melaksanakan_tugas/'.$h->id) ?>" title="Lihat Surat" target="_blank"><span class="fa-stack"><i class="fa fa-eye fa-stack-2x"></i></span></a>                                    
                                        <?php }?>
                                        <!-- Kondisi jika surat belum ditandatangan tidak bisa preview surat --> 
...
<!--============ START [UPDATE] Fikri Egov ================ [UPDATE] Fikri Egov ============================ [UPDATE] Fikri Egov ========================= [UPDATE] Fikri Egov ================================================-->
                                    ...
                                    ?>
                                    | <a href="<?php echo site_url('suratkeluar/melaksanakan_tugas/edit/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Ubah Surat"><span class="fa-stack"><i class="fa fa-pencil fa-stack-2x"></i></span></a> 
                                    
                                    <?php if ($h->dibuat_id == $this->session->userdata('jabatan_id')) {  ?>
                                    | <a href="<?php echo site_url('suratkeluar/melaksanakan_tugas/delete/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Hapus Surat" onclick="return confirm('Apakah anda yakin akan menghapus?')"><span class="fa-stack"><i class="fa fa-trash-o fa-stack-2x"></i></span></a>
                                    ...
                                    <?php 
                                        ...
                                        if ($this->session->userdata('jabatan_id') == $h->verifikasi_id OR $h->verifikasi_id == 0) {
                                            ...
                                            if($this->session->userdata('level') == 5){
                                                if($kop_id['kop_id'] == 4 || $kop_id['kop_id'] == 3 || $kop_id['kop_id'] == 1){ // Update @Mpik Egov 25/07/2022 ?>
                                                    | <a href="javascript:void(0)" data-toggle="modal" data-target="#modalPengajuan<?php echo $h->id ?>" title="Teruskan Surat"><span class="fa-stack"><i class="fa fa-mail-forward fa-stack-2x"></i></span></a>
                                                <?php        
                                                }else{
                                                    echo '';
                                                ...
                                                if($kop_id['kop_id'] == 1 || $kop_id['kop_id'] == 3 || $kop_id['kop_id'] == 6 || $kop_id['kop_id'] == 7){ // Update @Mpik Egov 25/07/2022  ?>  
                                                    | <a href="javascript:void(0)" data-toggle="modal" data-target="#modalPengajuan<?php echo $h->id ?>" title="Teruskan Surat"><span class="fa-stack"><i class="fa fa-mail-forward fa-stack-2x"></i></span></a>
                                                <?php        
                                                }else{
                                                    echo '';
