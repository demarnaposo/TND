...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo site_url('suratkeluar/memo') ?>">Surat Memo</a></li>
...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Formulir Surat Memo</h2>
</div>
<!-- END PAGE TITLE -->                
    ...
    <div class="row"> 
        <div class="col-md-12">
            ...
            <?php if ($this->uri->segment(3) == 'add') { ?>
                ...
                <!-- START DEFAULT FORM -->
                <form class="form-horizontal" action="<?php echo site_url('suratkeluar/memo/insert') ?>" method="post" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <a href="javascript:history.back()" class="btn btn-default">&laquo; Kembali</a>
                        <a href="<?= site_url()?>assets/reviewsurat/MEMO.pdf" target="_blank" class="btn btn-default" style="margin-left: 1%">Template Surat</a>
                    </div>
                    <div class="panel-body">                                                                        
                            ...
                            <div class="col-md-12"> 
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">                           
                                            <select name="kepada_id" class="form-control select 2" data-live-search="true">
                                                <option value="">-- Pilih --</option>
                                                <?php foreach ($jabatan as $key => $h) { ?> 
                                                    <option value="<?php echo $h->jabatan_id ?>" <?php if($h->jabatan_id == $this->session->flashdata('value_kepada_id')) echo "selected"?>><?php echo $h->nama_jabatan; ?></option>
                                                <?php } ?>
                                            </select>
                                            <span class="help-block"><font color="red"><?php echo $this->session->flashdata('kepada_id') ?></font></span>   
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Dari</label>
                                        <div class="col-md-10">                           
                                            <select name="dari_id" class="form-control select 2" data-live-search="true">
                                                <option value="">-- Pilih --</option>
                                                <?php foreach ($jabatan as $key => $h) { ?> 
                                                    <option value="<?php echo $h->jabatan_id ?>" <?php if($h->jabatan_id == $this->session->flashdata('value_dari_id')) echo "selected"?>><?php echo $h->nama_jabatan; ?></option>
                                                <?php } ?>
                                            </select>
                                            <span class="help-block"><font color="red"><?php echo $this->session->flashdata('dari_id') ?></font></span>   
                                        </div>
                                    </div>
                                    <!-- Update @Mpik Egov 28/07/2022 -->
                                <div class="form-group">
            ...
            ?>
                ...
                <!-- START DEFAULT FORM -->
                <form class="form-horizontal" action="<?php echo site_url('suratkeluar/memo/update') ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <?php foreach (listOpd($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        ...
                                                        <a href="<?php echo site_url('suratkeluar/memo/delete_kepada/'.$this->uri->segment(4).'/'.$o->dsuratkeluar_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-10">                           
                                            <select name="kepada_id" class="form-control select 2" data-live-search="true">
                                                <option value="">-- Pilih --</option>
                                                <?php foreach ($jabatan as $key => $h) { ?> 
                                                    <option value="<?php echo $h->jabatan_id ?>"<?php if($h->jabatan_id==$e->kepada_id){echo"selected";} ?>><?php echo $h->nama_jabatan; ?></option>
                                                <?php } ?>
                                            </select>   
                                        </div>
                                    </div>
                                <div class="form-group">
                                        ...
                                        <div class="col-md-10">                           
                                            <select name="dari_id" class="form-control select 2" data-live-search="true">
                                                <option value="">-- Pilih --</option>
                                                <?php foreach ($jabatan as $key => $h) { ?> 
                                                    <option value="<?php echo $h->jabatan_id ?>"<?php if($h->jabatan_id==$e->dari_id){echo"selected";} ?>><?php echo $h->nama_jabatan; ?></option>
                                                <?php } ?>
                                            </select>   
                                        </div>
                                    </div>
                                            ...
                                            <div class="faq-text">
                                                ...
                                                <?php foreach (listTembusan($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        - <?= $q->nama_jabatan;?>
                                                        <a href="<?php echo site_url('suratkeluar/memo/delete_tembusan/'.$this->uri->segment(4).'/'.$o->tembusansurat_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
