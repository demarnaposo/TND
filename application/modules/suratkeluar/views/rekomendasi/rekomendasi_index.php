...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Surat Rekomendasi </h2>
</div>
<!-- END PAGE TITLE -->                
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <a href="<?php echo site_url('suratkeluar/rekomendasi/add') ?>" class="btn btn-primary"><i class="fa fa-plus"></i>Buat Surat</a> <br><br>
		    ...
		    <table class="table datatable table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <?php
                                    $kode=$this->db->query("SELECT kode_surat.kode, kode_surat.tentang FROM surat_rekomendasi LEFT JOIN kode_surat ON kode_surat.kodesurat_id=surat_rekomendasi.kodesurat_id WHERE surat_rekomendasi.kodesurat_id='$h->kodesurat_id'")->row_array();
                                ...
                                <td>
                                    <?php
                                    $kop_id=$this->db->query("SELECT kop_surat.nama FROM surat_rekomendasi LEFT JOIN kop_surat ON kop_surat.kop_id=surat_rekomendasi.kop_id WHERE surat_rekomendasi.kop_id='$h->kop_id'")->row_array();
                                    echo $kop_id['nama'];
                                    ?>
                                </td>
                                <td>
                                ...
                                <td style="font-weight: bold;">
                                    ...
                                    <?php 
                                        ...
                                        $qverifikasi = $this->db->query("
                                            ...
                                            JOIN surat_rekomendasi ON verifikasi.surat_id = surat_rekomendasi.id
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <?php 
                                                $berada = $this->db->query("
                                                    SELECT * FROM draft
                                                    JOIN surat_rekomendasi ON surat_rekomendasi.id = draft.surat_id 
                                                    JOIN aparatur ON aparatur.jabatan_id = draft.verifikasi_id
                                                    JOIN jabatan ON jabatan.jabatan_id = aparatur.jabatan_id
                                                    WHERE surat_rekomendasi.id = '$h->id' AND aparatur.statusaparatur = 'Aktif'
                                                ")->row_array();
					...
					<!-- Kondisi jika surat belum ditandatangan tidak bisa preview surat -->
                                        ...
                                        <?php }else{?>
                                            <a href="<?php echo site_url('export/rekomendasi/'.$h->id) ?>" title="Lihat Surat" target="_blank"><span class="fa-stack"><i class="fa fa-eye fa-stack-2x"></i></span></a>                                    
                                        <?php }?>
                                        <!-- Kondisi jika surat belum ditandatangan tidak bisa preview surat --> 
...
<!--============ START [UPDATE] Fikri Egov ================ [UPDATE] Fikri Egov ============================ [UPDATE] Fikri Egov ========================= [UPDATE] Fikri Egov ================================================-->
                                    ...
                                    ?>
                                    | <a href="<?php echo site_url('suratkeluar/rekomendasi/edit/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Ubah Surat"><span class="fa-stack"><i class="fa fa-pencil fa-stack-2x"></i></span></a> 
                                    
                                    <?php if ($h->dibuat_id == $this->session->userdata('jabatan_id')) {  ?>
                                    | <a href="<?php echo site_url('suratkeluar/rekomendasi/delete/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Hapus Surat" onclick="return confirm('Apakah anda yakin akan menghapus?')"><span class="fa-stack"><i class="fa fa-trash-o fa-stack-2x"></i></span></a>
