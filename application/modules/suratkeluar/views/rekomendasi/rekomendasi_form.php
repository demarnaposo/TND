...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Formulir Surat Rekomendasi</h2>
</div>
<!-- END PAGE TITLE -->                
            ...
            <?php if ($this->uri->segment(3) == 'add') { ?>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <a href="<?= site_url()?>assets/reviewsurat/SURAT REKOMENDASI.pdf" target="_blank" class="btn btn-default" style="margin-left: 1%">Template Surat</a>
                    </div>
                    <div class="panel-body">                                                                        
                        ...
                        <div class="row">
				            ...
				            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Menimbang</label>
                                    <div class="col-md-10">
					                   <textarea id="textarea2" name="menimbang" rows="3"><?php echo $this->session->flashdata('value_menimbang') ?></textarea>
                                       <span class="help-block"><font color="red"><?php echo $this->session->flashdata('menimbang') ?></font></span>
                                    </div>
                                </div>	
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Isi</label>
                                    <div class="col-md-10">
					                   <textarea id="textarea3" name="isi" rows="3"><?php echo $this->session->flashdata('value_isi') ?></textarea>
                                                ...
                                                <?php foreach (listOpd($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        ...
                                                        <a href="<?php echo site_url('suratkeluar/rekomendasi/delete_kepada/'.$this->uri->segment(4).'/'.$o->dsuratkeluar_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
                        ...
                        <br><div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">                                        
                                    <label class="col-md-2 control-label">Tentang</label>
                                    <div class="col-md-10">
                                        <input type="text" name="tentang" class="form-control" value="<?= $e->tentang; ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Dasar</label>
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Menimbang</label>
                                    <div class="col-md-10">
										<textarea id="textarea2" name="menimbang" rows="6"><?php echo $e->menimbang ?></textarea>
                                    </div>
                                </div>										
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Isi</label>
                                    <div class="col-md-10">
										<textarea id="textarea3" name="isi" rows="6"><?php echo $e->isi ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">                                        
                                    <label class="col-md-2 control-label">Catatan</label>
                                            ...
                                            <div class="faq-text">
                                                ...
                                                <?php foreach (listTembusan($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        - <?= $q->nama_jabatan;?>
                                                        <a href="<?php echo site_url('suratkeluar/rekomendasi/delete_tembusan/'.$this->uri->segment(4).'/'.$o->tembusansurat_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
