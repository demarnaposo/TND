...
<ul class="breadcrumb">
    ...
    <li class="active">Draft Penomoran</li>
</ul>
<!-- END BREADCRUMB -->

<!-- PAGE TITLE -->
<div class="page-title">
    <h2><span class="fa fa-envelope"></span> Draft Penomoran </h2>
</div>
<!-- END PAGE TITLE -->
        ...
        <div class="col-md-12">
            ...
            <?php if ($this->session->userdata('level') == 4 || $this->session->userdata('level') == 18) { ?>
                <div class="alert alert-danger" role="alert">
                    <h4><b>Keterangan : Draft penomoran</b> menampilkan surat yang belum diberikan penomoran dan pemilihan penandatangan. Pilih <b> menu Draft Surat</b> untuk menampilkan surat yang <b>sudah dinomori dan ditandatangani</b></h4>
                </div>
            <?php } ?>
                                    ...
                                    ")->row_array();
                                        ...
                                        <td align="center">
                                            ...
                                            ?>
                                                ...
                                                <?php
                                                // =============== START [UPDATE] Fikri Egov 2 Maret 2022 ======================================================== [UPDATE] Fikri Egov 2 Maret 2022 ======================================================== [UPDATE] Fikri Egov 2 Maret 2022 ======================================================== [UPDATE] Fikri Egov 2 Maret 2022 ========================================================
                                                ...
                                                if (
                                                    ...
                                                    or $h->kopizin == 4 or $h->koppanggilan == 4 or $h->kopnodin == 4 or $h->koppengumuman == 4 or $h->koplaporan == 4
