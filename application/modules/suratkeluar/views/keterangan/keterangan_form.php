...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Formulir Surat Keterangan</h2>
</div>
<!-- END PAGE TITLE -->                
            ...
            <?php if ($this->uri->segment(3) == 'add') { ?>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <a href="<?= site_url()?>assets/reviewsurat/SURAT KETERANGAN.pdf" target="_blank" class="btn btn-default" style="margin-left: 1%">Template Surat</a>
                    </div>
                    <div class="panel-body">                                                                        
                        ...
                        <div class="row">
				            ...
				            <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select name="pegawai_id" class="form-control select" data-live-search="true">
                                            ...
                                            <?php foreach ($pegawai as $key => $a) { ?> 
                                                <option value="<?php echo $a->aparatur_id ?>" <?php if($a->aparatur_id == $this->session->flashdata('value_pegawai')) echo "selected"?>><?php echo $a->nip; ?> - <?php echo $a->nama; ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="maksud" value="<?php echo $this->session->flashdata('value_maksud') ?>"/>
				                ...
				                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
					                <textarea id="textarea1" name="penutup" rows="6"><?php echo $this->session->flashdata('value_penutup') ?></textarea>
                                                ...
                                                <?php foreach (listOpd($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        ...
                                                        <a href="<?php echo site_url('suratkeluar/keterangan/delete_kepada/'.$this->uri->segment(4).'/'.$o->dsuratkeluar_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
			                 ...
			                 <div class="form-group">
				                ...
				                <div class="form-group">
                                    <label class="col-md-2 control-label">Paragrap Penutup</label>
                                    <div class="col-md-10">
					               <textarea id="textarea1" name="penutup" rows="6"><?php echo $e->penutup ?></textarea>
                                    </div>
                                </div>	
                                <div class="form-group">                                        
                                    <label class="col-md-2 control-label">Catatan</label>
                                            ...
                                            <div class="faq-text">
                                                ...
                                                <?php foreach (listTembusan($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        - <?= $q->nama_jabatan;?>
                                                        <a href="<?php echo site_url('suratkeluar/keterangan/delete_tembusan/'.$this->uri->segment(4).'/'.$o->tembusansurat_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
