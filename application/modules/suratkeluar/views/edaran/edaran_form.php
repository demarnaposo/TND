...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Formulir Surat Edaran</h2>
</div>
<!-- END PAGE TITLE -->                
            ...
            <?php if ($this->uri->segment(3) == 'add') { ?>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <a href="<?= site_url()?>assets/reviewsurat/SURAT EDARAN.pdf" target="_blank" class="btn btn-default" style="margin-left: 1%">Template Surat</a>
                    </div>
                    <div class="panel-body">                                                                        
                        ...
                        <div class="row">
                            ...
                            <!-- Update @Mpik Egov 28/07/2022 -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
										<textarea name="isi" id="textarea1"><?php echo $this->session->flashdata('value_isi') ?></textarea>
                    ...
                    <div class="panel-body">                                                                        
                        ...
                        <br><div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">Isi Edaran</label>
								<div class="col-md-10">
									<textarea name="isi" id="textarea1"><?php echo $e->isi ?></textarea>
								</div>	
                            </div>
                            <div class="form-group">                                        
                                    <label class="col-md-2 control-label">Catatan</label>
                                            ...
                                            <div class="faq-text">
                                                ...
                                                <?php foreach (listTembusan($this->uri->segment(4)) as $key => $o) {
                                                 ...
                                                 ?>
                                                    <p>
                                                        - <?= $q->nama_jabatan;?>
                                                        <a href="<?php echo site_url('suratkeluar/edaran/delete_tembusan/'.$this->uri->segment(4).'/'.$o->tembusansurat_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } }?>
                                            </div>
                                        </div>
                        ...
                        <br><div class="col-md-12">
                            <div class="form-group">                                        
                                ...
                                <div class="col-md-4">                                                                                
                                    ...
                                    <!-- Modal Eksternal -->
                                    <!--<div class="modal fade" id="modalTembusanEks" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">-->
                                    <!--  <div class="modal-dialog" role="document">-->
                                    <!--    <div class="modal-content">-->
                                    <!--      <div class="modal-header">-->
                                    <!--        <h5 class="modal-title" id="exampleModalLabel">Form Data Pengiriman Eksternal</h5>-->
                                    ...
                                    <!--                    <div class="col-md-10">-->
                                    <!--                        <input type="text" class="form-control" name="namatembusan"> -->
                                    <!--                    </div>-->
                                    <!--                </div>-->
                                    <!--            </div><br><br><br>-->
                                    <!--            <div class="col-md-12">-->
                                    ...
                                    <!--                    <div class="col-md-10">-->
                                    <!--                        <input type="text" class="form-control" name="emailtembusan"> -->
                                    <!--                    </div>-->
                                    <!--                </div>-->
                                    <!--            </div>-->
                                    <!--            <div class="col-md-12">-->
                                    <!--                <br><br> <center> <button class="btn btn-info" type="submit" name="simpan_tembusan">Simpan</button></center>-->
                                    <!--            </div>-->
                                    <!--        </div>-->
                                    <!--      </div>-->
                                    <!--      <div class="modal-footer">-->
