    ...
    <div class="row"> 
        <div class="col-md-12">
            ...
            <?php if ($this->uri->segment(3) == 'add') { ?> 
				...
				<div class="col-sm-1">                           
                                            <input type="button" class="btn btn-info" id="select_all" name="select_all" value="Select All">
                                        </div>
					...
					<textarea id="isi2" name="hal"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select multiple name="jabatan_id[]" id="jabatan_id" class="form-control select" data-live-search="true">
                                            <?php foreach (sendOpd() as $key => $h) { 
                                                ...
                                                foreach($query->result() as $ky => $q){
                                            ?> 
                                                <option value="<?php echo $h->jabatan_id ?>"><?php echo $h->nama_pd; echo ' - '.$h->nama_jabatan; ?></option>
                                            <?php } }?>
                                        </select>   
                                    </div>
                                    <label class="col-md-2 control-label">Kepada Eksternal</label>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Isi</label>
                                    <div class="col-md-10">
                                        <textarea id="isi" name="isi"><?php echo $e->isi ?></textarea>
                                    </div>
                                </div>									
                            </div>                            
                        </div>
...
$('#select_all').click(function() {
    $('#jabatan_id option').prop('selected', true);
});
 </script>
