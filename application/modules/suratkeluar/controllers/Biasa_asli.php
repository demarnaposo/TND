	...
	public function insert()
	{
		...
		//Untuk menambahkan surat
			...
			if (empty($file)) {
				...
				$this->form_validation->set_rules('kop_id','ID Kop Surat', 'required');
       				$this->form_validation->set_rules('kodesurat_id','ID Kode Surat', 'required');

				if($this->form_validation->run()===FALSE) {
				$this->form_validation->set_message('kop_id', 'Kop surat tidak boleh kosong');
