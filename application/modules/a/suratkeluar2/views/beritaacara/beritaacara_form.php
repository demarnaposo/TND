...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Form Surat Berita Acara</h2>
</div>
<!-- END PAGE TITLE -->                 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Pihak Pertama</label>
                                    <div class="col-md-5">
                                        <select id="pihakpertama_id "name="pegawai_id[]"  multiple="multiple" class="form-control select" data-live-search="true">
                                            <option value="">Pilih Pegawai</option>
                                            <?php foreach ($pegawai as $key => $a) { ?> 
												<option value="<?php echo $a->aparatur_id ?>"><?php echo $a->nip; ?> - <?php echo $a->nama; ?></option>
											 <?php } ?>
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Pihak Kedua</label>
                                    <div class="col-md-5">
                                        <select id="pihakkedua_id "name="pegawai_id[]"  multiple="multiple" class="form-control select" data-live-search="true">
                                            <option value="">Pilih Pegawai</option>
                                            <?php foreach ($pegawai as $key => $a) { ?> 
												<option value="<?php echo $a->aparatur_id ?>"><?php echo $a->nip; ?> - <?php echo $a->nama; ?></option>
											 <?php } ?>
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Isi</label>
                                    <div class="col-md-10">
										<textarea name="isi" rows="6" class="summernote"><?php echo $e->isi ?></textarea>
                                    </div>
                                </div>										
