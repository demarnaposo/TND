                    ...
                    <table class="table datatable table-responsive table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <?php
                                    $kepada=$this->db->query("select b.nama_jabatan from surat_panggilan a left join jabatan b on b.jabatan_id=a.kepada_id where a.id='$h->id'")->result();
                                    foreach($kepada as $key){
                                ...
                                <td align="center">
                                    <a href="<?php echo site_url('export/panggilan/'.$h->id) ?>" title="Lihat Surat" target="_blank"><i class="fa fa-eye"></i></a> 
                                    ...
                                    ?>
                                    | <a href="<?php echo site_url('suratkeluar/panggilan/edit/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Edit Surat"><i class="fa fa-pencil"></i></a> 
                                    
                                    <?php if ($h->dibuat_id == $this->session->userdata('jabatan_id')) { ?>
                                    | <a href="<?php echo site_url('suratkeluar/panggilan/delete/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Hapus Surat" onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class="fa fa-trash-o"></i></a>
                                    <?php 
                                                }
                                            }
                                        }
