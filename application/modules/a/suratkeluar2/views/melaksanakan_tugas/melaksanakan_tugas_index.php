                    ...
                    <table class="table datatable table-responsive table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <?php 
                                                $berada = $this->db->query("
                                                    ...
                                                    WHERE surat_melaksanakantugas.id = '$h->id'
                                                ")->row_array();
                                ...
                                <td align="center">
                                    <a href="<?php echo site_url('export/melaksanakan_tugas/'.$h->id) ?>" title="Lihat Surat" target="_blank"><i class="fa fa-eye"></i></a> 
                                    ...
                                    ?>
                                    | <a href="<?php echo site_url('suratkeluar/melaksanakan_tugas/edit/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Edit Surat"><i class="fa fa-pencil"></i></a> 
                                    
                                    <?php if ($h->dibuat_id == $this->session->userdata('jabatan_id')) { ?>
                                    | <a href="<?php echo site_url('suratkeluar/melaksanakan_tugas/delete/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Hapus Surat" onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class="fa fa-trash-o"></i></a>
                                    <?php 
                                                }
                                            }
                                        }
                                    ...
                                    <form action="<?php echo site_url('suratkeluar/edaran/verify') ?>" method="post"> <br>
