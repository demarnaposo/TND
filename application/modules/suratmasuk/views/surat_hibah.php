...
<ul class="breadcrumb">
    ...
    <li class="active">Surat Masuk Hibah</li>
</ul>
<!-- END BREADCRUMB -->
...
<div class="page-title">                    
    ...
    <h2><img src="<?= site_url('assets/img/icons/icon-surat-masuk.png')?>" width="30px"> Surat Masuk Hibah </h2>
</div>
<!-- END PAGE TITLE -->                
        ...
        <div class="col-md-12">
		    ...
		    <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php if($surathibah == NULL){?>
                            <tr>
                                <td colspan="8" align="center">Tidak Ada Data</td>
                            </tr>
                            <?php
                            }else{
                                foreach ($surathibah as $key => $h) {
                            ?>
                            <tr>
