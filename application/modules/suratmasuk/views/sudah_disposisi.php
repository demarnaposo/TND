        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="row">
                    ...
                    <form role="form" method="get" action="<?php echo site_url('suratmasuk/inbox/sudahdisposisi');?>">
                    <div class="col-lg-3">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo site_url('suratmasuk/inbox/detaildatariwayat/'.$h->suratmasuk_id) ?>" class="btn btn-warning"><i class="fa fa-info-circle"></i> Detail Data Surat</a>
                                </td>
                            </tr>
                            <?php
                                } }
