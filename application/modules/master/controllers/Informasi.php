...
class Informasi extends CI_Controller {
	...
	public function index()
	{
		...
		$data['data'] = $this->db->query("SELECT nama, jabatan.nama_jabatan, COUNT(jabatan.jabatan_id) as jumlahtte FROM penandatangan inner join jabatan on penandatangan.jabatan_id=jabatan.jabatan_id WHERE status = 'Sudah Ditandatangani' GROUP by jabatan.jabatan_id ORDER by jumlahtte DESC")->result();
