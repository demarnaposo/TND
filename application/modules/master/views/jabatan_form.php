...
<div class="page-title">                    
    <h2><span class="fa fa-bookmark"></span> Formulir Data Jabatan</h2>
</div>
<!-- END PAGE TITLE -->                
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select name="opd_id" class="form-control select" data-live-search="true" required>
                                    ...
                                    <div class="col-md-10">
                                        <select name="atasan_id" class="form-control select" data-live-search="true">
                                            ...
                                            <?php foreach ($jabatan as $key => $h) { ?> 
                                                <option value="<?php echo $h->jabatan_id ?>"><?php echo $h->kode_pd.' - '.$h->nama_jabatan; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <select name="atasan_id" class="form-control select" data-live-search="true" >
                                            ...
                                            <?php foreach ($jabatanoption as $key => $h) { ?> 
                                                <option value="<?php echo $h->jabatan_id ?>" <?php if ($h->jabatan_id == $e->atasan_id) { echo "selected"; } ?>>
                                                    <?php echo $h->nama_pd.' - '.$h->nama_jabatan; ?>
                                                </option>
                                            <?php } ?>
                                        </select>
                                    </div>
