    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-primary" role="alert">
              <h4><i class="fa fa-info-circle"></i> <b>Keterangan :</b> Dibutuhkan izin untuk penambahan data aparatur</h4>
            </div>
            <!-- START TABS -->                                
            <div class="panel panel-default tabs">                            
                ...
                <div class="panel-body tab-content">
                    ...
                    <?php if($this->session->userdata('level') == 2){
                        ...
                        $permission= $this->db->query("SELECT * FROM permission_user WHERE users_id='$usersid'")->row_array();
                        ...
                        <a href="<?php echo site_url('master/aparatur/add') ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                        <?php } ?>
                        <a href="<?php echo site_url('master/aparatur/pindah') ?>" class="btn btn-primary"><i class="fa fa-user"></i> Pindah Aparatur</a> <br><br>
			...
			<table class="table datatable table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $h->nohp; ?></td>
                                    <td><?php echo $h->nama_pd; ?></td>
                                    <td><?php echo $h->nama_jabatan; ?></td>
				                    <td><?php echo $h->statusaparatur; ?></td>
				                    <td><?php echo $h->golongan; ?></td>
				                    <td><?php echo $h->level; ?></td>
                                    <td align="center">
                                        <div class="btn-group">
                                            <a href="#" data-toggle="dropdown" class="btn btn-primary dropdown-toggle"><i class="fa fa-cogs"></i></a>
                                            <ul class="dropdown-menu" role="menu">
                                                <li>
                                                    <a href="<?php echo site_url('master/aparatur/edit/'.$h->aparatur_id) ?>"><i class="fa fa-pencil"> Ubah</i></a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo site_url('master/aparatur/delete/'.$h->aparatur_id) ?>" onclick="return confirm('Apakah anda yakin akan menghapus? Data aparatur dan data users akan ikut terhapus')"><i class="fa fa-trash-o"></i> Hapus</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
                        ...
                        <table class="table datatable table-responsive table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <div class="btn-group">
                                            <a href="#" data-toggle="dropdown" class="btn btn-primary"><i class="fa fa-cogs"></i></a>
                                            <ul class="dropdown-menu" role="menu">
                                                <li>
