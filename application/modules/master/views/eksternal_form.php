...
<div class="page-title">                    
    <h2><span class="fa fa-external-link"></span> Formulir Data Perangkat Eksternal</h2>
</div>
<!-- END PAGE TITLE -->                
        ...
        <div class="col-md-12">
            ...
            <?php if ($this->uri->segment(3) == 'add') { ?>
				...
				<div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="alamat_eksternal" class="form-control" />
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-2 control-label">Tempat (Nama Kota/Kab)</label>
                                    <div class="col-md-10">
            ...
            ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Email</label>
                                    <div class="col-md-10">
                                        <input type="text" name="email" class="form-control" value="<?php echo $e->email ?>" required />
                                    </div>
                                </div>
				...
				<div class="form-group">
                                    <label class="col-md-2 control-label">Alamat</label>
                                    <div class="col-md-10">
                                        <input type="text" name="alamat_eksternal" class="form-control" value="<?php echo $e->alamat_eksternal ?>" />
                                    </div>
                                </div>
