...
<div class="content-frame">                                    
    ...
    <div class="content-frame-top">                        
        <div class="page-title">                    
            <h2><span class="fa fa-envelope"></span> Messages</h2>
        </div>
    </div>
    ...
    <div class="content-frame-right">
        ...
        <div class="list-group list-group-contacts border-bottom push-down-10">
            ...
            <a href="#" class="list-group-item">
                <img src="<?php echo base_url('assets/assets/images/users/user4.jpg') ?>" class="pull-left" alt="Brad Pitt">
                <span class="contacts-title">Brad Pitt</span>
                <p>ok</p>                     
            </a>
            <a href="#" class="list-group-item">
                <img src="<?php echo base_url('assets/assets/images/users/no-image.jpg') ?>" class="pull-left" alt="Darth Vader">
                <span class="contacts-title">Darth Vader</span>
                <p>We should win this war!!!1</p>
            </a>
            <a href="#" class="list-group-item">
                <img src="<?php echo base_url('assets/assets/images/users/no-image.jpg') ?>" class="pull-left" alt="Kim Kardashian">
                <span class="contacts-title">Kim Kardashian</span>
                <p>You received a letter from Darth?</p>
            </a>
            <a href="#" class="list-group-item">
                <img src="<?php echo base_url('assets/assets/images/users/no-image.jpg') ?>" class="pull-left" alt="Jason Statham">
    ...
    <div class="content-frame-body content-frame-body-left">
        ...
        <div class="messages messages-img">
            <div class="item in">
                <div class="image">
                    <img src="<?php echo base_url('assets/assets/images/users/user2.jpg') ?>" alt="John Doe">
                </div>
                <div class="text">
                    <div class="heading">
                        <a href="#">John Doe</a>
            ...
            <div class="item">
                <div class="image">
                    <img src="<?php echo base_url('assets/assets/images/users/user.jpg') ?>" alt="Dmitry Ivaniuk">
                </div>                                
                <div class="text">
                    <div class="heading">
