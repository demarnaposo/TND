...
<div class="page-content-wrap">
    ...
    <div class="row">
                    ...
                    <div class="widget-data">
                        <div class="widget-int num-count">
                            <?php
                                ...
                                echo $countsuratmasuk;

                            ?>    
                        </div>
                        <div class="widget-title">Surat Masuk</div>
                        <div class="widget-subtitle">Terdapat <?php echo $countsuratmasuk; ?> total surat yang harus didisposisikan</div>
                    </div>
                </div>                            
                </a>                         
        ...
        <?php }else{ ?>
            ...
            <div class="col-md-4">
                <!-- START WIDGET SURAT MASUK -->
                <a href="<?php echo site_url('suratkeluar/instruksi') ?>">
                <div class="widget widget-disposisi widget-item-icon">
                    <div class="widget-item-left">
                        <!-- <span class="fa fa-envelope"></span> -->
                    ...
                    <div class="widget-data">
                        <div class="widget-int num-count"> <?php echo $pengajuansurat ?> </div>
                        <div class="widget-title"><b>Pembuatan Draft Surat</b></div>
            ...
            <div class="col-md-4">
                ...
                <div class="widget widget-suratmasuk widget-item-icon">
                    ...
                    <div class="widget-data">
                        ...
                        <div class="widget-title"><b>Draft Surat</b></div>
 ...
 <div class="col-md-4">
                ...
                <div class="widget widget-arsip widget-item-icon">
                    <div class="widget-item-left">
                        <!-- <span class="fa fa-envelope"></span> -->
                        <img src="<?= site_url('/assets/img/icons/icon-ttd.png')?>" width="64px">
                    </div>                             
                    <div class="widget-data">
                        <div class="widget-int num-count"><?php echo $tandatangan; ?></div>
                        <div class="widget-title"><b>Tanda Tangan Surat</b></div>
