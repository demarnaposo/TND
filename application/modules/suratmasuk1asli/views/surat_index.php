    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-primary" role="alert">
              <h4><b>Keterangan :</b> Untuk melihat surat | lembar disposisi | dan aksi lainnya bisa klik tombol aksi <i class="fa fa-info-circle"></i> untuk melihat detail data</h4>
            </div>
            <div class="alert alert-warning" role="alert">
              <h4><b>Keterangan :</b> Untuk melihat alur penerusan surat pilih klik tombol aksi <i class="fa fa-info-circle"></i> </h4>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <a href="<?php echo site_url('suratmasuk1/surat/add') ?>" class="btn btn-primary"><i class="fa fa-plus"></i>Tambah Surat</a>
                    </div>
                    <?php echo form_open_multipart('suratmasuk1/surat')?>
                    <div class="col-lg-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                        ...
                                        <?php }else{ ?>
                                            <font style='color:orange; text-align:center;'> <b>SURAT SEDANG BERJALAN</b></font>
                                        <?php 
                                        }
                                        }else{
                                    ?>
                                ...
                                <td>
                                    ...
                                    <!-- <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="<?php echo site_url('suratmasuk1/surat/edit/'.$h->suratmasuk_id) ?>"><i class="fa fa-pencil"></i> Ubah</a></li>
                                            <li><a class="dropdown-item" href="<?php echo site_url('suratmasuk1/surat/delete/'.$h->suratmasuk_id) ?>" onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class="fa fa-trash-o"></i> Hapus</a></li>
                                        <li><a class="dropdown-item" href="<?php echo site_url('suratmasuk1/surat/detaildata/'.$h->suratmasuk_id) ?>"><i class="fa fa-info-circle"></i> Detail Data Surat</a></li>
                                      </ul>
                                    </div> -->
                                    <!-- Ubah Data --><a href="<?php echo site_url('suratmasuk1/surat/edit/'.$h->suratmasuk_id) ?>" title="Ubah Data"><span class="fa-stack"><i class="fa fa-pencil fa-stack-2x"></i></span></a> |
                                    <!-- Hapus Data --><a href="<?php echo site_url('suratmasuk1/surat/delete/'.$h->suratmasuk_id) ?>" onclick="return confirm('Apakah anda yakin akan menghapus?')" title="Hapus Data"><span class="fa-stack"><i class="fa fa-trash-o fa-stack-2x"></i></span></a> |
                                    <!-- Detail Data --><a href="<?php echo site_url('suratmasuk1/surat/detaildata/'.$h->suratmasuk_id) ?>" title="Detail Data"><span class="fa-stack"><i class="fa fa-info-circle fa-stack-2x"></i></span></a>
                                    <?php }else{ ?>
                                        <a href="<?php echo site_url('suratmasuk1/surat/detaildata/'.$h->suratmasuk_id) ?>" class="btn btn-warning"><i class="fa fa-info-circle"></i> Detail Data Surat</a>
                                    <?php } ?>
                                </td>
                            </tr>
                            <?php
