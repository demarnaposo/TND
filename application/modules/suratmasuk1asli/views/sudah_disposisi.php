        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="row">
                    ...
                    <?php echo form_open_multipart('suratmasuk1/inbox/sudahdisposisi')?>
                    <div class="col-lg-3">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo site_url('suratmasuk1/inbox/detaildatariwayat/'.$h->suratmasuk_id) ?>" class="btn btn-warning"><i class="fa fa-info-circle"></i> Detail Data Surat</a>
                                </td>
                            </tr>
                            <?php
                                }
