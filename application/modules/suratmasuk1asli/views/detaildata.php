    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <a href="<?php echo site_url('suratmasuk1/surat') ?>" class="btn btn-primary">Kembali</a>
                        ...
                        if($qdisposisi->num_rows() == 0){ ?>
                            <a href="<?php echo site_url('suratmasuk1/surat/disposisi/'.$suratid) ?>" titl="Disposisi Surat" class="btn btn-info"><i class="fa fa-mail-forward"></i>Disposisi</a>
                        <?php } }?>
                    </div>
                </div><br>
